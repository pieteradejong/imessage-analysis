...
def get_chat_analysis(db: DatabaseConnection, chat_identifier: str) -> Dict[str, Any]:
    ...
    if total_messages > 0:
        analysis['from_me']['percentage'] = (analysis['from_me']['message_count'] / total_messages) * 100
        analysis['from_others']['percentage'] = (analysis['from_others']['message_count'] / total_messages) * 100
